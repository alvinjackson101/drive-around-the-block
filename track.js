...
function addSquare(square, squareTop, squareLeft) {
    ...
    switch(parseInt(square.m)) {
        case 0:
            img.setAttribute("class", "square r0 ");
            img.setAttribute("id", "intersection-top-right");
            break;
        case 90:
            img.setAttribute("class", "square r90 ");
            img.setAttribute("id", "intersection-bottom-right");
            break;

        case 180:
            img.setAttribute("class", "square r180");
            img.setAttribute("id", "intersection-bottom-left");
            break;

        case 270:
            img.setAttribute("class", "square r270 ");
            img.setAttribute("id", "intersection-top-left");
            break;
    }
